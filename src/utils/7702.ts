import { Account, Address, concat, CustomSource, encodeAbiParameters, encodeFunctionData, encodePacked, Hex, parseAbi, SignedAuthorization, zeroAddress } from "viem";
import { INTENT_EXECUTOR_ADDRESS } from "../account";
...
export async function signDelegation(acc: CustomSource, chain: number, nonce: number, delegatedContract: Address): Promise<SignedAuthorization> {
